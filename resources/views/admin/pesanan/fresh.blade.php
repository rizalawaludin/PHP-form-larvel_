@extends('layouts.app')
@section('title','List Pesanan Fresh')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">List Pesanan Fresh</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    @if($product->count() > 0)
                    <button class="btn btn-primary delete_all" data-url="{{ url('order_delete')  }}">Pesanan Tersedia</button>
                    <a href="/order/fresh/export" class="btn btn-success">Tarik Data</a><br><br>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/ksjalan/fresh') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if (session('success'))
                            <div class="alert alert-success">
                                {{ session('success') }}
